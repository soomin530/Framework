...
-- /myPage/profile/20241112153654_00002.jfif 이 중에
-- 파일명인 20241112153654_00002.jfif만 조회해서 가져가야 함
SELECT SUBSTR(PROFILE_IMG, INSTR(PROFILE_IMG, '/', -1) +1) "rename" -- 20241112153654_00002.jfif 
FROM "MEMBER"
WHERE PROFILE_IMG IS NOT NULL
UNION 
SELECT CAST(IMG_RENAME AS VARCHAR2(300))"rename"  -- VARCHAR2(300)로 변환
FROM "BOARD_IMG";
