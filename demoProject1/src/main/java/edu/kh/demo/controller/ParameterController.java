...
@RequestMapping("param")		// /param으로 시작하는 요청을
								// 현재 컨트롤러로 매핑
@Slf4j // log를 이용한 메시지 출력 시 사용 (Lombok 제공) -> 메서드에 사용하면 에러. 클래스에서만 사용
public class ParameterController {
	 ...
	 * 매개변수에 원하는 객체를 작성하면
	 * 존재하는 객체를 바인딩(연결해줌) 또는 없으면 생성해서 바인딩
	 * 
	...
	//   자동으로 setter를 호출해서 필드에 값을 세팅 (다를 땐 null)
	...
	@PostMapping("test4")   // /param/test4 POST 요청 매핑
	public String paramTest4(/*@ModelAttribute*/ MemberDTO inputMember) {
	  							// ㄴ 어노테이션 생략 가능!     ㄴ 커멘드 객체
