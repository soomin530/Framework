...
public class EmailConfig {
	...
	// @Value : properties에 작성된 내용 중 key가 일치하는 value 값을 얻어와 필드에 대입
	// @Autowired는 Bean 등록된 것들만 사용 가능해서 여기서는 못 쓴다
	
	@Value("${spring.mail.username}") // lombok 거 아님!!!
	...
	public JavaMailSender javaMailSender() {
		...
		// Spring 어플리케이션에서 이메일을 보내기 위한 구성을 제공함
